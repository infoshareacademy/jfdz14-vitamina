...
class Food {
     ...
     foodsTypeRandom() {
          const badFood = [
               'url(./Game_elements/burger.svg)',
               'url(./Game_elements/pizza.svg)',
               'url(./Game_elements/frytki.svg)',
          ]
          const goodFood = [
               'url(./Game_elements/jablko.svg)',
               'url(./Game_elements/marchewka.svg)',
               'url(./Game_elements/brokul.svg)',
          ]
